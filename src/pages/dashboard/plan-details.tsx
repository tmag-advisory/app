                        ...
                        <div className="min-w-0 space-y-3">
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-amber-900/85">
                                    Our system flagged this plan for review. We&apos;ll update this plan as soon as we have more information, but feel free to reach out to support if you have any questions in the meantime.
                                </p>
                            </div>
