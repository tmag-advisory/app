                    ...
                    <div className="space-y-10 text-sm text-body leading-relaxed">
                        <section>
                            ...
                            <p className="mb-2">
                                ...
                                Name, email address, and password when you
                                create an account.
                            </p>
                            <p className="mb-2">
                                <strong className="text-heading">
                                ...
                                Pre-existing conditions, medications, allergies,
                                and other health details you voluntarily provide
                            ...
                            <p className="mb-2">
                                ...
                                Destinations, dates, planned activities, and
                                travel companions.
                            </p>
                            <p>
                                <strong className="text-heading">
                                ...
                                Pages visited, features used, and general
                        ...
                        <section>
                            ...
                            <p>
                                Your account data and generated plans are
                        ...
                        <section>
                            ...
                            <p>
                                ...
                                data; correct inaccurate data; delete your data
                                and account; export your data in a portable
                                format; and withdraw consent for optional data
                        ...
                        <section>
                            ...
                            <p>
                                ...
                                session management. We use optional analytics
                                cookies to understand usage patterns. You can
                        ...
                        <section>
                            ...
                            <p>
                                ...
                                processing, email delivery, and infrastructure
                                hosting. These providers are contractually bound
                                to protect your data and may only process it as
                                instructed by us.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p>
                                ...
                                or in-app notification at least 30 days before
                                taking effect.
                            </p>
                        </section>
